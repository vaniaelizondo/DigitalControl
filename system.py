...
# Graficar
    ...
    axs[1].legend(['m[k]', 'Input dist.', 'Output dist.'], loc='upper right')
    ...
    # print('t: {}    mk: {}'.format(t,mk))
    # print('t: {}    rk: {}'.format(t,rk))
...
mainGUI = Tk()
mainGUI.title("Control system simulation")
...
rbAuto = Radiobutton(mainGUI, text='Automatic', indicatoron=False, selectcolor='magenta', variable=modoOperacion, value='auto')
rbCero = Radiobutton(mainGUI, text='Zero order', indicatoron=False, selectcolor='cyan', variable=ordenPlanta, value='cero')
rbPrimero = Radiobutton(mainGUI, text='First order', indicatoron=False, selectcolor='cyan', variable=ordenPlanta, value='primero')
rbPID = Radiobutton(mainGUI, text='PID', indicatoron=False, selectcolor='yellow', variable=controlador, value='PID')
rbEcGral = Radiobutton(mainGUI, text='General Eq.', indicatoron=False, selectcolor='yellow', variable=controlador, value='ecgral')
...
Label(mainGUI, text='Input disturbance', anchor=W, justify=RIGHT).grid(row=20, column=2) 
Label(mainGUI, text='Output disturbance', anchor=W, justify=RIGHT).grid(row=20, column=4) 
...
# Botones
Button(mainGUI, text='Apply', command=pertEntrada).grid(row=21, column=3)
Button(mainGUI, text='Apply', command=pertSalida).grid(row=21, column=5)
Button(mainGUI, text='Start', command=startGraphs).grid(row=23, column=3)
Button(mainGUI, text='Finish', command=mainGUI.destroy).grid(row=23, column=4)

# Creacion de graficas interactivas
plt.ion()
plt.show()
fig, axs = plt.subplots(2, sharex=True)
axs[0].set_title('Reference r(k) and Output c(k)')
axs[0].set_ylabel('Amplitude')
axs[1].set_title('Manipulation m(k), Input disturbance and Output disturbance')
